...
if __name__ == "__main__":
	...
	MODEL_NAMES = ['spectral', 'phoneme', 'word2vec', 'gpt2', 'gpt2-xl']
	...
	all_cmds = []
	script_fn = os.path.join(os.getcwd(), 'run_encoding_extraction.py')
	...
	joblist_fn = os.path.join(joblist_dir, f'{p.dataset}_encoding_extraction_joblist.txt')

	with open(joblist_fn, 'w') as f:
		for cmd in all_cmds:
			f.write(f"{cmd}\n")
	
	dsq_base_string = f'dsq_encoding_extraction'
