#!/bin/bash
#SBATCH --output /dartfs/rc/lab/F/FinnLab/tommy/isc_asynchrony_behavior/code/modeling/careful-whisper/scripts/submit_scripts/logs/dsq_av-combined_careful_whisper_experiments/dsq_av-combined_careful_whisper_experiments-%A_%2a-%N.txt
#SBATCH --array 0-9
