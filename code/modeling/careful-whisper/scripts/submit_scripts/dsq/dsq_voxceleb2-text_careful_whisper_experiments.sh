#!/bin/bash
#SBATCH --output /dartfs/rc/lab/F/FinnLab/tommy/isc_asynchrony_behavior/code/modeling/careful-whisper/scripts/submit_scripts/logs/dsq_voxceleb2-text_careful_whisper_experiments/dsq_voxceleb2-text_careful_whisper_experiments-%A_%1a-%N.txt
#SBATCH --array 0-3
#SBATCH --job-name dsq-voxceleb2-text_careful_whisper_experiments
