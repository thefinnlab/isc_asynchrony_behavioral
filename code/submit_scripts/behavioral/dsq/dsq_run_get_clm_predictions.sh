#!/bin/bash
#SBATCH --output /dartfs/rc/lab/F/FinnLab/tommy/isc_asynchrony_behavior/derivatives/logs/behavioral/dsq_run_get_clm_predictions/dsq_run_get_clm_predictions-%A_%2a-%N.txt
#SBATCH --array 0-53
